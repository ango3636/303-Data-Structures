...
void Professional:: output(){
  cout << name << "!"<< endl<< "Your monthly salary is: $"<< monthlySalary(years) << endl << "$"<< healthPlus(monthlySalary(years)) << " went towards your health contributions."<< endl<< "You have " << vacationTime(years) << " weeks of vacation this year!" << endl;
}